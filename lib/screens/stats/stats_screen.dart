...
class _StatsScreenState extends ConsumerState<StatsScreen> {
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          final clientsVal =
                              ref.read(clientsProvider).valueOrNull;
                          if (entriesVal == null || clientsVal == null) {
                            if (context.mounted) {
                              CustomToast.show(
                                  context, 'Veriler henüz hazır değil');
                            }
                            return;
                          }
                          try {
                            ...
                            if (context.mounted) {
                              CustomToast.show(
                                  context, '$name.pdf indiriliyor');
                            }
                          } catch (e) {
                            if (context.mounted) {
                              CustomToast.show(
                                  context, 'PDF oluşturulurken hata: $e');
                            }
                          }
                        },
                        child: Container(
  ...
  Widget _buildHoursView(
      AppPalette c, List<Client> clients, List monthEntries, bool isWide) {
    ...
    for (var entry in monthEntries) {
      ...
      if (pId != null && pId.isNotEmpty && pName != null && pName.isNotEmpty) {
        projectHours[pId] = (projectHours[pId] ?? 0) + entry.durationHours;
      ...
      children: [
        ...
        ...sortedClientIds.asMap().entries.map((entry) {
          ...
          final client = clients.firstWhere(
            (cl) => cl.id == clientId,
            orElse: () =>
                Client(id: clientId, name: 'Bilinmeyen', color: '#9CA3AF'),
          );
          final percentage = (hours / totalHours) * 100;
          final color = colors[index % colors.length];
                    ...
                    children: [
                      ...
                      ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          backgroundColor: c.shimmer1.withValues(alpha: 0.3),
        ...
        if (sortedProjectIds.isNotEmpty) ...[
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: PieChart(
                PieChartData(
                  sections: sortedProjectIds.asMap().entries.map((entry) {
                    final index = entry.key;
  ...
  Widget _buildEarningsView(
    ...
    final int daysCount =
        _daysInMonth(_selectedMonth.year, _selectedMonth.month);
    ...
    final bool hasDailyData = dailyEarnings.any((v) => v > 0);
                      ...
                      titlesData: FlTitlesData(
                        ...
                        bottomTitles: AxisTitles(
                          ...
                          sideTitles: SideTitles(
                            showTitles: true,
                            interval:
                                (daysCount > 16) ? 5 : (daysCount > 8 ? 2 : 1),
