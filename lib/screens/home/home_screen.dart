...
class HomeShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // to a navbar tab and leave no active item.
    int currentIndex = 0;
    if (location.contains('/overview')) {
      currentIndex = 1;
  ...
  Widget _buildNavItem(
    ...
    final c = AppColors.of(context);
    const navLabels = ['Ana Sayfa', 'Genel Bakış', 'Raporlar', 'Ayarlar'];
    return Tooltip(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () => context.go('/home/overview'),
                            child: Text(
                              'Tümünü Gör',
                              style: TextStyle(
                                color: c.primary,
